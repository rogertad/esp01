...
//IPAddress ip(192, 168, 0, 111);      // preencha aqui o endereço IP fixo desejado
//IPAddress gateway(192, 168, 0, 1);   // preencha aqui o endereço IP do gateway
//IPAddress subnet(255, 255, 255, 0);  // preencha aqui a máscara de sub-rede
//IPAddress dns(8, 8, 8, 8);           // preencha aqui o endereço IP do servidor DNS

WiFiServer server(80);
int PORTA = 0;  // PORTA connected to  GPIO0
